...
const SearchResults = ({ loginStatus, setLoggedIn, setLoggedOut, productName, setProductName }) => {
  ...
  return (
    <>
      ...
      <ProductList itemPrice={itemPrice} itemCategory={itemCategory} productName={productName}/>
      <Footer />
    </>
  );
};
